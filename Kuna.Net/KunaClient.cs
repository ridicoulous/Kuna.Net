...
namespace Kuna.Net
{
    public class KunaClient : RestClient, IKunaClientV2, IKunaClientV3
    {
        ...
        {
            var result = await SendRequestAsync<string>(GetUrl(ServerTimeEndpoint), HttpMethod.Get, ct, null, false, false).ConfigureAwait(false);
        ...
        {
            var result = await SendRequestAsync<KunaTickerInfoV2>(GetUrl(FillPathParameter(MarketInfoV2Endpoint, market)), HttpMethod.Get, ct, null, false, false).ConfigureAwait(false);
        ...
        public async Task<CallResult<KunaOrderBookV2>> GetOrderBookV2Async(string market, int limit = 1000, CancellationToken ct = default)
        {
            ...
            var result = await SendRequestAsync<KunaOrderBookV2>(GetUrl(OrderBookV2Endpoint), HttpMethod.Get, ct, parameters).ConfigureAwait(false);
        ...
        public async Task<CallResult<List<KunaTradeV2>>> GetTradesV2Async(string market, DateTime? toDate = null, long? fromId = null, long? toId = null, int limit = 1000, string sort = "desc", CancellationToken ct = default)
        {
            ...
            var result = await SendRequestAsync<List<KunaTradeV2>>(GetUrl(AllTradesEndpoint), HttpMethod.Get, ct, parameters, false, false).ConfigureAwait(false);
        ...
        {
            var result = await SendRequestAsync<KunaAccountInfoV2>(GetUrl(AccountInfoEndpoint), HttpMethod.Get, ct, null, true, false).ConfigureAwait(false);
        ...
        public async Task<CallResult<KunaPlacedOrderV2>> PlaceOrderV2Async(KunaOrderTypeV2 type, KunaOrderSideV2 side, decimal volume, decimal price, string market, CancellationToken ct = default)
        {
            ...
            var result = await SendRequestAsync<KunaPlacedOrderV2>(GetUrl(OrdersV2Endpoint), HttpMethod.Post, ct, parameters, true, false).ConfigureAwait(false);
        ...
        public async Task<CallResult<KunaPlacedOrderV2>> CancelOrderV2Async(long orderId, CancellationToken ct = default)
        {
            ...
            var result = await SendRequestAsync<KunaPlacedOrderV2>(GetUrl(CancelOrderEndpoint), HttpMethod.Post, ct, parameters, true, false).ConfigureAwait(false);
            return new CallResult<KunaPlacedOrderV2>(result.Data, result.Error);
        }
        ...
        public async Task<CallResult<List<KunaPlacedOrderV2>>> GetMyOrdersV2Async(string market, KunaOrderStateV2 orderState = KunaOrderStateV2.Wait, int page = 1, string sort = "desc", CancellationToken ct = default)
        {
            ...
            var result = await SendRequestAsync<List<KunaPlacedOrderV2>>(GetUrl(OrdersV2Endpoint), HttpMethod.Get, ct, parameters, true, false).ConfigureAwait(false);
        ...
        public async Task<CallResult<KunaPlacedOrderV2>> GetOrderInfoV2Async(long orderId, CancellationToken ct = default)
        {
            ...
            var result = await SendRequestAsync<KunaPlacedOrderV2>(GetUrl(SingleOrderV2Endpoint), HttpMethod.Get, ct, parameters, true, false).ConfigureAwait(false);
            return new CallResult<KunaPlacedOrderV2>(result.Data, result.Error);
        }
        ...
        public async Task<CallResult<List<KunaTradeV2>>> GetMyTradesV2Async(string market, DateTime? toDate = null, long? fromId = null, long? toId = null, int limit = 1000, string sort = "desc", CancellationToken ct = default)
        {
            ...
            parameters.AddOptionalParameter("limit", limit);
            var result = await SendRequestAsync<List<KunaTradeV2>>(GetUrl(MyTradesEndpoint), HttpMethod.Get, ct, parameters, true, false).ConfigureAwait(false);
            return new CallResult<List<KunaTradeV2>>(result.Data, result.Error);
        }
        public async Task<CallResult<List<KunaOhclvV2>>> GetCandlesHistoryV2Async(string symbol, int resolution, DateTime from, DateTime to, CancellationToken ct = default)
        {
            ...
            var result = await SendRequestAsync<TradingViewOhclvV2>(GetUrl(CandlesHistoryEndpoint, "3"), HttpMethod.Get, ct, parameters, false, false).ConfigureAwait(false);
        ...
        async Task<WebCallResult<ICommonTicker>> IExchangeClient.GetTickerAsync(string symbol)
        {
            ...
            var singleTickerResult = new WebCallResult<KunaTicker>(
                ...
                result.Error);
            return singleTickerResult.As<ICommonTicker>(singleTickerResult.Data);
        }
