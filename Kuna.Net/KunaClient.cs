...
price	цена (обязательна только для limit)
stop_price	цена, при достижении которой активируется ордер с типом limit_stop_loss; если не задана, то берется значение параметра price*/
